    ...
    <div className="relative w-[140px] h-[140px] flex-shrink-0">
      <svg style={{ transform:'rotate(-90deg)', width:140, height:140 }} viewBox="0 0 140 140">
        ...
        <circle cx="70" cy="70" r="55" fill="none"
          ...
          strokeDasharray="345" strokeDashoffset="76"
        />
      </svg>
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-[38px] font-black tracking-[-2px] leading-none gradient-text-score">78</span>
    ...
    <div className="max-w-[1280px] mx-auto px-10 pb-16">
      ...
      <div className="relative overflow-hidden rounded-3xl mb-6 flex items-center gap-10 p-9"
        ...
        <div className="flex-1">
          <h2 className="text-[22px] font-bold mb-2 tracking-tight">SolarGrid West Africa Initiative</h2>
          <div className="flex items-center gap-3 flex-wrap mb-4">
            {['🌍 Senegal, Mali, Guinea','⚡ Solar + Mini-Grid','📅 2024–2027','💰 $48M'].map((t) => (
          ...
          <span className="inline-flex items-center gap-1.5 px-5 py-2 rounded-full text-[14px] font-bold"
                style={{ background:'rgba(255,193,7,0.12)', border:'1px solid rgba(255,193,7,0.25)', color:'#FFD54F' }}>
            ✦ Gold Level — OEI Certified
          </span>
        </div>
      ...
      <div className="grid gap-7" style={{ gridTemplateColumns:'1fr 380px' }}>
        ...
        <div className="flex flex-col gap-5">
          <GlassCard>
            ...
            {[
              ['Project ID', '#OEI-2024-0847'],
              ['Evaluator', 'OEI AI Engine'],
              ['Last Updated', 'Apr 6, 2026'],
              ['Certification', '✦ Gold', '#FFD54F'],
              ['Budget', '$48,000,000'],
              ['Beneficiaries', '1.2M people'],
              ['CO₂ Reduction', '−24,000 t/yr', '#81C784'],
            ].map(([lbl, val, color]) => (
